...
public class AuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(assertion==null){
            ...
            String casAuthPath=properties.getServerLoginUrl()+Protocol.CAS2.getServiceParameterName()+"=";
            String servicePath=properties.getClientHostUrl()+"/auth?frontRoute=";
            ...
            preCasAuthenticationRequestResult.setMessage("返回data对象给前端，前端进行url拼接:" +
                    ...
                    "2、decodedService=java.net.URLDecoder.decode(service, \"UTF-8\")。"+
                    "3、authPath=data.casAuthPath+decodeService。"+
